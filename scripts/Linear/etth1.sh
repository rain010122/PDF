...
python -u run_longExp.py \
  ...
  --patience 10\
  --itr 1 --batch_size 32 --learning_rate 0.005 
  # >logs/LongForecasting/$model_name'_'Etth1_$seq_len'_'192.log
...
python -u run_longExp.py \
  ...
  --patience 10\
  --itr 1 --batch_size 32 --learning_rate 0.005 
  # >logs/LongForecasting/$model_name'_'Etth1_$seq_len'_'336.log
...
python -u run_longExp.py \
  ...
  --patience 10\
  --itr 1 --batch_size 32 --learning_rate 0.005 
  # >logs/LongForecasting/$model_name'_'Etth1_$seq_len'_'720.log